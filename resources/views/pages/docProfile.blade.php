...
@section('content')
    <main id="main" class="tg-page-wrapper tg-haslayout">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="tg-haslayout ads-dashboard-top">
                        <div id="ads_widget-5" class="address-column tg-ads-wgdets">
                            <div class="tg-add-wrapper">
                                <a href="https://themeforest.net/item/docdirect-responsive-directory-wordpress-theme-for-doctors-and-healthcare-profession/16089820?s_rank=2"
                                   target="_blank"><img
                                            src="http://themographics.com/wordpress/directory/wp-content/uploads/2017/03/Blue_770-x-175.jpg"
                                            title="ad"></a></div>
                        </div>
                    </div>
                </div>
                    ...
                    <aside id="tg-sidebar" class="dashboard-sidebar">
                        <div class="tg-widget tg-widget-doctor">
                            <figure class="tg-docprofile-img">
                                <figcaption>
                                    <h4><a target="_blank" title="View Profile"
                                           href="">{{$post->speciality}}</a></h4>
                                    <span>Vetrenarian</span>
                                </figcaption>
                                <a><img src={{asset('storage/'.$post->image)}}
                                        alt="Avatar"></a>
                            </figure>
                        </div>
                        <div class="tg-doctors-list tg-haslayout">
                            <div id="ads_widget-6" class="address-column tg-ads-wgdets">
                                <div class="tg-add-wrapper">
                                    <a href="https://themeforest.net/item/docdirect-responsive-directory-wordpress-theme-for-doctors-and-healthcare-profession/16089820?s_rank=2"
                                       target="_blank"><img
                                                src="http://themographics.com/wordpress/directory/wp-content/uploads/2017/03/Blue_370-x-370.jpg"
                                                title="ad"></a></div>
                            </div>
                        </div>
                    </aside>
                                    ...
                                    <div class="tg-docinfo tg-haslayout">
                                        <div class="tg-box">
                                            ...
                                            <div class="tg-bottominfo tg-haslayout">
                                                <div class="tg-regardsleft"><em>Regards,</em> <strong>A Complete
                                                        Business Listing Solution</strong></div>
                                                <div class="tg-regardsright"><strong class="logo"><img
                                                                src="storage/pages/logo.png"
                                                                alt="sousHealth"></strong></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tg-support">
                                        ...
                                        <ul class="tg-doccontactinfo">
                                            <li><i class="fa fa-map-marker"></i>
                                                <address>{{$post->adresse}}</address>
                                            </li>
                                            <li><i class="fa fa-phone"></i><a href="tel:+44 235 8568432">{{$post->tel}}</a></li>
                                        ...
                                        <li>
                                            <div class="tg-review">
                                                <figure class="tg-reviwer-img">
                                                    <a href="http://themographics.com/wordpress/directory/doctor/steve/"><img
                                                                src="http://themographics.com/wordpress/directory/wp-content/uploads/2016/04/img-01-1-140x89.jpg"
                                                                alt="Reviewer"></a>
                                                </figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="row">
                                ...
                                <div class="tg-ratingbox">
                                    ...
                                    <strong>very good</strong></div>
                                <a class="tg-btn"
                                   href="http://themographics.com/wordpress/directory/doctor/professional/">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
                            ...
                            datasets: [
                                {
                                    ...
                                    data: [2, 142, 192, 310, 88, 0, 0, 0, 0, 0, 0, 0]
                                },
                            ]
                        };
        ...
        <script type="text/template" id="tmpl-load-gallery">
            <figure>
                <a href="javascript:;"><img height="56" width="56" src=""></a>
                <div class="tg-img-hover" data-attachment_id="">
                    <a href="javascript:;" data-attachment=""><i class="fa fa-plus"></i><i
        ...
        <script type="text/template" id="tmpl-load-awards">
            ...
            <tr>
                <td data-title="Code">Award Title
                        ...
                        <div class="">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <input class="form-control" value="" name="" type="text" placeholder="Award Name">
                                </div>
                            </div>
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <input class="form-control award_datepicker" id="award_datepicker" value="" name=""
                                           type="text" placeholder="Award Date">
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="" placeholder="Award Description"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <td class="" colspan="2">
                            <div class="tg-education-form tg-haslayout">
                                <div class="">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <input class="form-control award_datepicker" id="award_datepicker" value=""
                                                   name="" type="text" placeholder="Award Date">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                ...
                <td class="" colspan="3">
                    <div class="">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input class="form-control" value="" name="" type="text" placeholder="Title">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input class="form-control" value="" name="" type="text" placeholder="Institute">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input class="" id="edu_start_date" value="" name="" type="text"
                                       placeholder="Start Date">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input class="" id="edu_end_date" value="" name="" type="text" placeholder="End Date">
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <textarea class="form-control" name="" placeholder="Education Description"></textarea>
                            </div>
                        </div>
                    </div>
                </td>
            ...
            <# if( _.isArray(data) && ! _.isEmpty(data) ) { #>
                <table class="table-striped educations_wrap" id="table-striped">
                    ...
                    <tr>
                        ...
                        <td data-title="Company"></td>
                        <td data-title="Price" class="numeric"></td>
                    </tr>
                    <tr>
                        <td class="" colspan="3">
                            <div class="">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input class="" id="edu_end_date" value="" name="" type="text"
            ...
            <tr>
                <td class="" colspan="3">
                    <div class="">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input class="" id="exp_start_date" value="" name="" type="text"
                                       placeholder="Start Date">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input class="" id="exp_end_date" value="" name="" type="text" placeholder="End Date">
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <textarea class="form-control" name="" placeholder="Experience Description"></textarea>
                            </div>
                        </div>
                    </div>
                </td>
                    ...
                    <tr>
                        <td class="" colspan="3">
                            <div class="">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input class="" id="exp_end_date" value="" name="" type="text"
                                               placeholder="End Date">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name=""
                                                  placeholder="Experience Description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </td>
